...
from model.base import BaseModel, DeepLossWrap, LossWrap
from model.utils import pad2same
from utils.losses import IOU_loss, focal_loss, ssim
...
'''
class UNet_3Plus_DeepSup(BaseModel):
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        self.h1_PT_hd4_relu = nn.ReLU(inplace=False)
    ...
    def forward(self, inputs):
        ...
        h4_Cat_hd4 = pad2same(h4_Cat_hd4, h1_PT_hd4)
        hd5_UT_hd4 = pad2same(hd5_UT_hd4, h1_PT_hd4)
        ...
        hd4_UT_hd3 = pad2same(hd4_UT_hd3, h1_PT_hd3)
        hd5_UT_hd3 = pad2same(hd5_UT_hd3, h1_PT_hd3)
        ...
        hd4_UT_hd2 = pad2same(hd4_UT_hd2, h1_PT_hd2)
        hd5_UT_hd2 = pad2same(hd5_UT_hd2, h1_PT_hd2)
        ...
        hd4_UT_hd1 = pad2same(hd4_UT_hd1, h1_Cat_hd1)
        hd5_UT_hd1 = pad2same(hd5_UT_hd1, h1_Cat_hd1)
    ...
    def hybrid_loss(pred, target):
        return focal_loss(pred, target, from_logits=True).mean() + IOU_loss(pred, target).mean() + ssim(pred, target).mean()
    
    def backward(self, x, optimer, closure=None, clear_stored=True):
        default = DeepLossWrap(
            {
                'focal':{
                    'loss': focal_loss,
                    'args':{}
