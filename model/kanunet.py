# https://github.com/jiaowoguanren0615/UNetKAN/tree/main
import torch
...
from model.modules import DropPath, _pair as to_2tuple
...
class UKAN(BaseModel):
    def __init__(self, num_classes, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
